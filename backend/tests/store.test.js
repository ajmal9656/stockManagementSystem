...
describe("Store API", () => {
  ...
  test("Admin should add store successfully", async () => {
  ...
  test("Shopper should not add store", async () => {
  ...
  test("Admin should get stores", async () => {
  ...
  test("Shopper should get stores", async () => {
